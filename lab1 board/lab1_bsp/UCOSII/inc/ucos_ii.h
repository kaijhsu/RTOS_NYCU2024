...
typedef struct os_tcb {
    ...
    // RTOS_LAB1-1: Add computation, period information of period task
    INT16U         compTime;           /* Execution counter*/
    INT16U         period;             /* The period of the task */
    int			   start;              /* Start time of the task */
...
// RTOS_LAB1-2: define variable for ISR
#define ISR_MESG_MAX_LEN 512
typedef struct {
    char mesg[ISR_MESG_MAX_LEN][1024];
    INT16U top;
} ISR_MESG;
extern ISR_MESG ISR_Mesg;
